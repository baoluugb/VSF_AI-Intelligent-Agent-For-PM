...
| 2.2 | **Entity extraction** (regex + rules)        | ⚠️ Partial | Meeting notes connector does regex extraction of issue keys, but there's no dedicated entity extraction pipeline orchestrator                                                                                                                                                           |
